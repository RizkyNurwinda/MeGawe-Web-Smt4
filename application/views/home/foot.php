	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3  col-md-12">
				<div class="single-footer-widget">
					<h6>Name of Team</h6>
					<ul class="footer-nav">
						<li><a href="#">Rizky Nurwinda(E31181097)</a></li>
						<li><a href="#">Nina Ardana(E31180...)</a></li>
						<li><a href="#">An Nissa Safitri(E31181391)</a></li>
						<li><a href="#">Nur Kumala Sari(E31181...)</a></li>
						<li><a href="#">Sasti Widia Sari(E31181...)</a></li>
					</ul>
				</div>
			</div>
			<!-- <div class="col-lg-3 col-sm-8 footer-social">
			...
			<div class="col-lg-3  col-md-12">
				...
				<h6>Tentang Kami</h6>
					<p>MeGawe adalah sebuah website yang menyediakan informasi lowongan pekerjaan dari berbagai jenis pekerjaan seperti kesehatan, marketing, akutansi dan masih banyak lagi. Selain itu MeGawe juga dapat memasukan lowongan pekerjaan.&rdquo;</p>
				</div>
			</div>						
		</div>
		...
		<div class="row footer-bottom d-flex justify-content-between">
			<p class="col-lg-8 col-sm-12 footer-text m-0 text-white">
				...
				Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by ShieClick
				<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			</p>

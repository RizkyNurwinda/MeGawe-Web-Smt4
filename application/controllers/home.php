...
class Home extends CI_Controller {
	...
	public function edit($id){
		$where=array('id'=>$id);
		$data['user']=$this->home_model->update_date($where,'lowongan')->result();
		$this->template->views('crud/edit',$data);
	}
	...
	public function member()
    {
		...
		$data['pendaftar'] = $this->lowongan->getAll2();
	...
	public function perusahaan()
    {
		...
		$data['perusahaan'] = $this->lowongan->getAll3();
		$this->load->view('home/dataperusahaan', $data);
	}

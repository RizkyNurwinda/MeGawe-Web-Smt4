...
--
-- Host: 127.0.0.1
-- Generation Time: 06 Jun 2020 pada 20.50
...
(10, 'karyawan', ' posisi sortir dan pengemasan', 'sma/smk sederajat', 8, '2020-06-06', 'buka', 3500000, 'jember', '1', 3, 6),
(11, 'karyawan', 'dapat mengoperasikan mesin bubut cnc', 'smk sederajat', 8, '2020-06-06', 'buka', 2000000, 'jember', '1', 2, 4),
(12, 'keamanan', 'menjaga area pabrik tetap aman serta kondusif serta dapat membantu keluar masuknya kendaraan', 'sma smk sederajat', 8, '2020-06-06', 'buka', 2500000, 'jember', '0', 4, 4),
(13, 'akuntan', 'dapat mendata keuangan dengan akurat', 'lulusan sarjana ekonomi', 8, '2020-06-06', 'buka', 4500000, 'jember', '1', 2, 1),
(14, 'system analis', 'dapat memaintenence software pada perusahaan', 'lulusan S,kom S,T', 8, '2020-06-06', 'buka', 5500000, 'jember', '1', 2, 2),
(15, 'marketing', 'aktif bermedia sosial dan mampu menarik perhatian customer', 'good looking \nsma smk sederajat', 8, '2020-06-06', 'buka', 3000000, 'jember', '1', 3, 6),
(16, 'manager', 'mampu mengevaluasi pekerjaan divisi, menjadi penengah dan pemecah masalah dalam perusahaan,mengembangkan kualitas perusaan', 'lulusan manajemen\ngood looking\ndapat menguasai crowd\n', 8, '2020-06-06', 'buka', 6000000, 'jember', '0', 1, 4);
...
(7, 'mabur speed', 'unknown', '1234', 'mbrspd@gmail.com', 'mbrspd.com', 'mboh', 'raroh', '2020-06-06', 4, '1.png', 8),
(8, 'PT MABUR JAYA SPEED', 'JEMBER', '081973789242', 'mbrspd@gmail.com', 'mbrspd.com', '  anda suka produk saya \r\nsaya suka uang anda ', '  TOP GLOBAL PABRIK SPAREPART  ', '2020-05-05', 4, 'Lighthouse.jpg', 9);
...
(9, 'bunga', '81dc9bdb52d04dc20036dbd8313ed055', 3);
...
--
ALTER TABLE `lowongan`
  MODIFY `idLowongan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
